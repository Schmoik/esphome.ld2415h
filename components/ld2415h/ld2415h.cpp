...
void LD2415HComponent::parse_config_param_(char *key, char *value) {
  ...
  switch (key[1]) {
    ...
    case '2':
      ...
      this->compensation_angle_->publish_state(this->compensation_angle_);
      break;
    case '3':
      this->sensitivity_ = std::stoi(value, nullptr, 16);
      this->sensitivity_->publish_state(this->sensitivity_);
      break;
    case '4':
      this->tracking_mode_ = this->i_to_tracking_mode_(v);
      this->tracking_mode_->publish_state(this->i_to_s_(TRACKING_MODE_STR_TO_INT, this->tracking_mode_));
      break;
    case '5':
      this->sample_rate_ = v;
      this->sample_rate_->publish_state(this->i_to_s_(SAMPLE_RATE_STR_TO_INT, this->sample_rate_));
      break;
    case '6':
    ...
    case '7':
      ...
      this->vibration_correction_->publish_state(this->vibration_correction_);
      break;
    case '8':
      this->relay_trigger_duration_ = v;
      this->relay_trigger_duration_->publish_state(this->relay_trigger_duration_);
      break;
    case '9':
      this->relay_trigger_speed_ = v;
      this->relay_trigger_speed_->publish_state(this->relay_trigger_speed_);
      break;
    case '0':
